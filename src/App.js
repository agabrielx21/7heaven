  ...
  return (
      ...
      <div className="container">
            <div className="card">
                ...
                <p>Cu serviciile cloud blockchain, datele tranzacționale din mai multe surse pot fi colectate, integrate și partajate cu ușurință. Blockchain oferă integritatea datelor printr-o singură sursă de informații, eliminând dublarea datelor și sporind securitatea.</p>
                <p>Într-un sistem blockchain, frauda și datele falsificate sunt împiedicate deoarece datele nu pot fi modificate fără permisiunea unui cvorum al părților. Un registru blockchain poate fi partajat, dar nu modificat. Dacă cineva încearcă să modifice datele, toți participanții vor fi alertați și vor ști cine face încercarea.</p>
                <p>În contextul adoptării rapide și a unei piețe în valoare de 20 de miliarde de dolari până la sfârșitul anului 2024, blockchain-ul este pregătit să transforme lumea tehnologiei. Acesta este exact genul de atenție care atrage unii dintre cei mai motivați atacatori, indiferent de nivelul de îndemânare al acestora.</p>
            </div>
            <div className="card">
                <h2>Ce oferim?</h2>
                <ul>
